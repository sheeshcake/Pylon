            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">{{ $data['user'][0]->f_name . " " . $data['user'][0]->l_name }}</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/accounts">Users</a></li>
                                    <li class="breadcrumb-item">{{ $data['user'][0]->f_name . " " . $data['user'][0]->l_name }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="file" class="form-control-file" name="user_image" id="image_input" multiple>
