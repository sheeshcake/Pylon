            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <a href="{{ route('newuser') }}" class="btn btn-success mb-3">Add New User</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="/accounts/removeuser/{{ $user->id }}" class="btn btn-danger mx-1">Delete</a>
                                            <a href="/accounts/viewuser/{{ $user->id }}" class="btn btn-primary mx-1">Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
